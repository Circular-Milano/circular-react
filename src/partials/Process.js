      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-10 pb-12 md:pt-16 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4" data-aos="fade-up">Find anything you might need</h2>
            <p className="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200">Circular helps you make money lending your unused items and try new activities at a low cost while reducing consumption and your carbon footprint!</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">1</span>. Search</h4>
              <p className="text-lg text-gray-400 text-center">Browse through items to find what you need.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">2</span>. Book</h4>
              <p className="text-lg text-gray-400 text-center">Reserve it for as long as you want.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">3</span>. Use</h4>
              <p className="text-lg text-gray-400 text-center">Enjoy your rental.</p>
            </div>

            {/* 4th item */}
            <div className="relative flex flex-col items-center" data-aos="fade-up">
              <div aria-hidden="true"  style={{ width: 'calc(100% - 32px)', left: 'calc(50% + 48px)', top: '32px' }} data-aos="fade-in" data-aos-delay="200"></div>
              <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                <rect className="fill-current text-purple-600" width="64" height="64" rx="32" />
                <path className="stroke-current text-purple-300" strokeWidth="2" strokeLinecap="square" d="M21 23h22v18H21z" fill="none" fillRule="evenodd" />
                <path className="stroke-current text-purple-100" d="M26 28h12M26 32h12M26 36h5" strokeWidth="2" strokeLinecap="square" />
              </svg>
              <h4 className="h4 mb-2"><span className="text-gray-400">4</span>. Return</h4>
              <p className="text-lg text-gray-400 text-center">Be sure to return your item in its original condition for the next person.</p>
            </div>
